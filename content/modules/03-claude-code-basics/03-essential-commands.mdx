...
quiz:
  - id: "commands-1"
    ...
    options:
      ...
      - "Checks for updates"
    correct: 2
    explanation: "The -c flag continues your most recent session. If you exited Claude Code and want to pick up where you left off, 'claude -c' restores the conversation history and context."
  - id: "commands-2"
