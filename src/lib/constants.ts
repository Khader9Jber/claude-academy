...
export const ARC_DEFINITIONS: ArcDefinition[] = [
  ...
  },
  {
    ...
    color: "#e06c75",
    description:
      "Apply your Claude skills to specific domains. Each track is an independent deep-dive — pick the ones that match your role and go deep.",
    range: "Modules 17, 19-25",
  },
];
