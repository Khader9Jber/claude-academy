...
quiz:
  - id: "first-mcp-1"
    ...
    options:
      ...
      - "claude mcp add github -e GITHUB_TOKEN=ghp_... --transport stdio npx -y @modelcontextprotocol/server-github"
      - "mcp install github"
      - "npm install mcp-github"
    correct: 1
    explanation: "The full command is: claude mcp add github -e GITHUB_TOKEN=ghp_... --transport stdio npx -y @modelcontextprotocol/server-github. This adds a server named 'github', passes your token as an environment variable, uses stdio transport, and runs the GitHub MCP server package."
  - id: "first-mcp-2"
